...
CREATE TABLE `khoan_thu` (
  ...
  `TenKhoanThu` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_vietnamese_ci NOT NULL,
...
INSERT INTO `khoan_thu` VALUES (1,'Tiền mừng',20000,0),(2,'nước',1000.12,1),(3,'Tiền Điện',200000,1);
