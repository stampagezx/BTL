...
CREATE TABLE `ho_khau` (
  ...
  `checkNoptien` varchar(200) COLLATE utf8mb4_vietnamese_ci DEFAULT 'Chưa nộp',
  `TenChuHo` varchar(45) COLLATE utf8mb4_vietnamese_ci DEFAULT NULL,
  PRIMARY KEY (`MaHo`)
...
INSERT INTO `ho_khau` VALUES (1,3,'ád',' Tiền Điện','ád'),(2,2,'ád',' nước, Tiền Điện','sad');
